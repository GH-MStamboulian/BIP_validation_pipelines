...
os.system("docker run --rm -v /ghds/:/ghds/ --user $(id -u):$(id -g) " + docker_image + " Rscript " + r_script_dir + r_script + " -d " + data_tables_dir + " -o " +out_dir1 + " -v " + version1)
...
os.system("docker run --rm -v /ghds/:/ghds/ --user $(id -u):$(id -g) " + docker_image + " Rscript " + r_script_dir + r_script + " -d " + data_tables_dir + " -o " +out_dir2 + " -v " + version2)

os.system("python3 combinePrecisionTables.py " + out_dir1 + " " + version1 + " " + out_dir2 + " " + version2 + " " + out_dir)
